...
-- Equation(s):
-- \INST8|mux_out[0]~0_combout\ = \sw[0]~input_o\ $ (((\sw[4]~input_o\ & !\pb_n[2]~input_o\)))
...
-- Equation(s):
-- \INST6|INST2|full_adder_coutput~0_combout\ = (\sw[1]~input_o\ & ((\sw[5]~input_o\) # ((\sw[0]~input_o\ & \sw[4]~input_o\)))) # (!\sw[1]~input_o\ & (\sw[0]~input_o\ & (\sw[4]~input_o\ & \sw[5]~input_o\)))
...
-- Equation(s):
-- \INST8|mux_out[2]~2_combout\ = \sw[2]~input_o\ $ (((!\pb_n[2]~input_o\ & (\INST6|INST2|full_adder_coutput~0_combout\ $ (\sw[6]~input_o\)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \INST6|INST2|full_adder_coutput~0_combout\,
...
-- Equation(s):
-- \INST6|INST3|full_adder_coutput~0_combout\ = (\INST6|INST2|full_adder_coutput~0_combout\ & ((\sw[6]~input_o\) # (\sw[2]~input_o\))) # (!\INST6|INST2|full_adder_coutput~0_combout\ & (\sw[6]~input_o\ & \sw[2]~input_o\))
...
-- pragma translate_on
PORT MAP (
	dataa => \INST6|INST2|full_adder_soutput~combout\,
	datab => \pb_n[2]~input_o\,
	datac => \sw[1]~input_o\,
...
-- Equation(s):
-- \INST1|Mux5~0_combout\ = (\INST8|mux_out[3]~3_combout\ & ((\INST8|mux_out[0]~0_combout\ & ((\INST8|mux_out[1]~1_combout\))) # (!\INST8|mux_out[0]~0_combout\ & (\INST8|mux_out[2]~2_combout\)))) # (!\INST8|mux_out[3]~3_combout\ & 
-- (\INST8|mux_out[2]~2_combout\ & (\INST8|mux_out[0]~0_combout\ $ (\INST8|mux_out[1]~1_combout\))))
...
PORT MAP (
	...
	datab => \INST8|mux_out[2]~2_combout\,
	datac => \INST8|mux_out[3]~3_combout\,
	datad => \INST8|mux_out[1]~1_combout\,
...
-- Equation(s):
-- \INST7|mux_out[0]~0_combout\ = (\sw[7]~input_o\ & ((\sw[3]~input_o\) # (\INST6|INST3|full_adder_coutput~0_combout\))) # (!\sw[7]~input_o\ & (\sw[3]~input_o\ & \INST6|INST3|full_adder_coutput~0_combout\))
...
-- Equation(s):
-- \INST7|mux_out[1]~2_combout\ = (\pb_n[2]~input_o\ & \sw[5]~input_o\)
...
-- Equation(s):
-- \INST2|Mux5~0_combout\ = (\INST7|mux_out[3]~4_combout\ & ((\INST7|mux_out[0]~1_combout\ & ((\INST7|mux_out[1]~2_combout\))) # (!\INST7|mux_out[0]~1_combout\ & (\INST7|mux_out[2]~3_combout\)))) # (!\INST7|mux_out[3]~4_combout\ & 
-- (\INST7|mux_out[2]~3_combout\ & (\INST7|mux_out[0]~1_combout\ $ (\INST7|mux_out[1]~2_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \INST7|mux_out[2]~3_combout\,
	datab => \INST7|mux_out[3]~4_combout\,
	datac => \INST7|mux_out[0]~1_combout\,
	datad => \INST7|mux_out[1]~2_combout\,
...
-- Equation(s):
-- \INST1|Mux1~0_combout\ = (\INST8|mux_out[2]~2_combout\ & ((\INST8|mux_out[1]~1_combout\ & (\INST8|mux_out[0]~0_combout\ & !\INST8|mux_out[3]~3_combout\)) # (!\INST8|mux_out[1]~1_combout\ & ((\INST8|mux_out[3]~3_combout\))))) # 
-- (!\INST8|mux_out[2]~2_combout\ & (!\INST8|mux_out[3]~3_combout\ & ((\INST8|mux_out[0]~0_combout\) # (\INST8|mux_out[1]~1_combout\))))
...
PORT MAP (
	dataa => \INST8|mux_out[0]~0_combout\,
	datab => \INST8|mux_out[2]~2_combout\,
	datac => \INST8|mux_out[1]~1_combout\,
...
-- Equation(s):
-- \INST2|Mux1~0_combout\ = (\INST7|mux_out[2]~3_combout\ & ((\INST7|mux_out[3]~4_combout\ & ((!\INST7|mux_out[1]~2_combout\))) # (!\INST7|mux_out[3]~4_combout\ & (\INST7|mux_out[0]~1_combout\ & \INST7|mux_out[1]~2_combout\)))) # 
-- (!\INST7|mux_out[2]~3_combout\ & (!\INST7|mux_out[3]~4_combout\ & ((\INST7|mux_out[0]~1_combout\) # (\INST7|mux_out[1]~2_combout\))))
...
-- Equation(s):
-- \INST1|Mux0~0_combout\ = (\INST8|mux_out[3]~3_combout\) # ((\INST8|mux_out[2]~2_combout\ & ((!\INST8|mux_out[1]~1_combout\) # (!\INST8|mux_out[0]~0_combout\))) # (!\INST8|mux_out[2]~2_combout\ & ((\INST8|mux_out[1]~1_combout\))))
...
-- Equation(s):
-- \INST2|Mux0~0_combout\ = (\INST7|mux_out[3]~4_combout\) # ((\INST7|mux_out[2]~3_combout\ & ((!\INST7|mux_out[1]~2_combout\) # (!\INST7|mux_out[0]~1_combout\))) # (!\INST7|mux_out[2]~3_combout\ & ((\INST7|mux_out[1]~2_combout\))))
...
-- Equation(s):
-- \INST1|Mux6~0_combout\ = (\INST8|mux_out[2]~2_combout\ & (!\INST8|mux_out[1]~1_combout\ & ((\INST8|mux_out[3]~3_combout\) # (!\INST8|mux_out[0]~0_combout\)))) # (!\INST8|mux_out[2]~2_combout\ & (\INST8|mux_out[0]~0_combout\ & (\INST8|mux_out[1]~1_combout\ 
...
-- Equation(s):
-- \INST2|Mux6~0_combout\ = (\INST7|mux_out[2]~3_combout\ & (!\INST7|mux_out[1]~2_combout\ & ((\INST7|mux_out[3]~4_combout\) # (!\INST7|mux_out[0]~1_combout\)))) # (!\INST7|mux_out[2]~3_combout\ & (\INST7|mux_out[0]~1_combout\ & (\INST7|mux_out[3]~4_combout\ 
-- $ (!\INST7|mux_out[1]~2_combout\))))
...
-- Equation(s):
-- \INST2|Mux4~0_combout\ = (\INST7|mux_out[2]~3_combout\ & (\INST7|mux_out[3]~4_combout\ & ((\INST7|mux_out[1]~2_combout\) # (!\INST7|mux_out[0]~1_combout\)))) # (!\INST7|mux_out[2]~3_combout\ & (!\INST7|mux_out[3]~4_combout\ & 
-- (!\INST7|mux_out[0]~1_combout\ & \INST7|mux_out[1]~2_combout\)))
...
-- Equation(s):
-- \INST2|Mux3~0_combout\ = (\INST7|mux_out[1]~2_combout\ & ((\INST7|mux_out[2]~3_combout\ & ((\INST7|mux_out[0]~1_combout\))) # (!\INST7|mux_out[2]~3_combout\ & (\INST7|mux_out[3]~4_combout\ & !\INST7|mux_out[0]~1_combout\)))) # 
-- (!\INST7|mux_out[1]~2_combout\ & (!\INST7|mux_out[3]~4_combout\ & (\INST7|mux_out[2]~3_combout\ $ (\INST7|mux_out[0]~1_combout\))))
...
-- Equation(s):
-- \INST2|Mux2~0_combout\ = (\INST7|mux_out[1]~2_combout\ & (((!\INST7|mux_out[3]~4_combout\ & \INST7|mux_out[0]~1_combout\)))) # (!\INST7|mux_out[1]~2_combout\ & ((\INST7|mux_out[2]~3_combout\ & (!\INST7|mux_out[3]~4_combout\)) # 
